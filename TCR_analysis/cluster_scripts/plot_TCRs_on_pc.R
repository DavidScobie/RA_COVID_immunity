...
sig_TCRs <- read.csv(paste0(data_path,"sig_TCRs_P_10exp(-7)_PCR_pos_alph_bet_day0_day7.csv.csv"))
all_pats_wide_plotting<-read.csv(paste0(data_path,"all_pats_wide_plotting_P_10exp(-7)_PCR_pos_alph_bet_day0_day7.csv"))
all_pats_wide_chopped_sig_lines_plotting <- read.csv(paste0(data_path,"all_pats_wide_chopped_sig_lines_plotting_P_10exp(-7)_PCR_pos_alph_bet_day0_day7.csv"))
all_pats_wide_sig_lines_plotting <- read.csv(paste0(data_path,"all_pats_wide_sig_lines_plotting_P_10exp(-7)_PCR_pos_alph_bet_day0_day7.csv"))
