...
#     if len(df2_Subj_ID_sub_eff_sort['Virus Titre (Log10 FFU/mL)'].tolist()) > 5:
#         k+=1
#         #convert the virus and the effective day values to a list
#         div_vir_list_sum = df2_Subj_ID_sub_eff_sort['Virus Titre (Log10 FFU/mL)'].tolist()
#         eff_day_list = df2_Subj_ID_sub_eff_sort['effective_day'].tolist()

#         print('Virus',len(df2_Subj_ID_sub_eff_sort['Virus Titre (Log10 FFU/mL)'].tolist()))   #print how many datapoints there are
